 ...
 */
    ...
    describe('CONTROLLER -  CtrlCreateProcess', function (){
        ...
        it('should add a step',function(){
         ...
         // di confronto. Altrimenti assegno ad entrambi i campi null
        ...
        it('should date have not a correct dateStartJSFormat', function(){
         ...
         $scope.createNewProcess();
         expect($scope.messageDetailsProcessError).toEqual('La data di inizio deve essere la stessa di oggi o una maggiore');
         expect($scope.showAlertDetailsError).toEqual('true');
        });
        ...
        it('should have inserted the right information', function(){
         ...
         $scope.createNewProcess();
         expect($scope.processDivVisible).toEqual('false');
         expect($scope.summaryProcessDivVisible).toEqual('true');
        });
        */
