...
describe('MODEL - PreAuthenticationRequestManager', function () {
    ...
    it('should do a recovery password and handle a success response', function(){
        ...
        $httpBackend.flush();
        expect($rootScope.$broadcast).toHaveBeenCalledWith('REQUEST_RECOVERY_PASSWORD_IS_END', 'Richiesta recupero password inviata con successo. Controlla la tua casella mail');
    });
