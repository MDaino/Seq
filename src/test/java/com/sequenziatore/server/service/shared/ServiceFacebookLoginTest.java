...
/**
 * 	File contentente la classe ServiceFacebookLoginTest
 * 
 *	@file		ServiceFacebookLoginTest.java
 *	@author		DeSQ
 *	@date		2014-05-14
 *	@version	1.0
 */
...
import com.sequenziatore.server.service.shared.ServiceFacebookLogin;

/**
 *	Classe contenente tutti i test di unità dei metodi della classe ServiceFacebookLogin. 
 *
 *	@author 	DeSQ
 */
public class ServiceFacebookLoginTest {
	...
	/**
	 *	Test del metodo serviceOperation() che permette ad un utente di effettuare login tramite Facebook
	 */
	@Test
    public void testServiceOperation() throws Exception {
		ServiceFacebookLogin serviceFacebookLogin = new ServiceFacebookLogin();
	    ...
	    JSONObject jsonObject = serviceFacebookLogin.serviceOperation(iEntityList);
	    assertEquals("successAuthentication", jsonObject.get("Confirmation"));

	    jsonObject = serviceFacebookLogin.serviceOperation(iEntityList);
	    assertEquals("successAuthentication", jsonObject.get("Confirmation"));
	}
